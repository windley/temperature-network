...
//
        ...
        payload_array = (payload.length() == 14) => dragino:get_payload("wl03a_lb_status", payload).klog("Payload status: ")
                      | (payload.length() == 22) => dragino:get_payload("wl03a_lb_data", payload).klog("Payload data: ")
                      | [];
