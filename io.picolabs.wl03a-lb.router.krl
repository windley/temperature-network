...
//
        ...
        payload_array = (payload.length() == 14) => dragino:get_payload("wl03a-lb-status", payload).klog("Payload status: ")
                      | (payload.length() == 22) => dragino:get_payload("wl03a-lb-data", payload).klog("Payload data: ")
                      | [];
